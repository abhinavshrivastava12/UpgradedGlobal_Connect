...
        
        // FIX: Add a check to ensure currentUser and its connection field exist
        if (currentUser && currentUser.connection && currentUser.connection.includes(targetUserId)) {
...
// NEW: Get call availability status
...
        // Check if users are connected (optional - you might want calls even without connections)
        let currentUser;
        try {
...
        // For now, allow calls if user is online (you can add more restrictions here)
